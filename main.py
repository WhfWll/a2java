...
def main():
    parser = argparse.ArgumentParser(prog='enjarify',
    ...
    if not os.path.exists(jar_path):
        os.mkdir(jar_path)
    outname = os.path.join(jar_path, outname)
    try:
    ...
    cfr_path = os.path.join(BASE_DIR, 'cfr_0_123.jar')
    java_source = os.path.join(BASE_DIR, 'java_source')
    args = ['java', '-jar', cfr_path, outname, '--outputdir', java_source]
